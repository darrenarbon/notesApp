app.service('CalendarService', function (dbCall, $rootScope, $q, checkDates, NotesDAO) {
    ...
    this.create5Days = function(){
        ...
        for (var i = 0; i < 5; i++) {
            ...
            days.push({date: dayNumbers, month: aMonths[dayWanted.getMonth()], colour: aColours[i]})
        }
        return days;
    };
